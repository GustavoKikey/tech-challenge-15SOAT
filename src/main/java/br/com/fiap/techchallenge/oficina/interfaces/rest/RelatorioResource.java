...
import br.com.fiap.techchallenge.oficina.application.relatorio.MonitorarTempoMedioUseCase;
import br.com.fiap.techchallenge.oficina.interfaces.rest.dto.relatorio.TempoMedioResponse;
...
/**
 * Endpoints de relatórios — read models do Event Storming. Sempre exigem
 * {@code ADMINISTRADOR}.
 */
@Path("/relatorios")
...
public class RelatorioResource {
    ...
    public RelatorioResource(MonitorarTempoMedioUseCase monitorar) {
    ...
    public TempoMedioResponse tempoMedioExecucao(
        ...
        return TempoMedioResponse.from(monitorar.executar(desdeDate, ateDate));
    }
}
