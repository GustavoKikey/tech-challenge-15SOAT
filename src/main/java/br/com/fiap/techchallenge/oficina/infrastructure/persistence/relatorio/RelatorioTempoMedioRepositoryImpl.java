package br.com.fiap.techchallenge.oficina.infrastructure.persistence.relatorio;
 ...
 */
@ApplicationScoped
public class RelatorioTempoMedioRepositoryImpl implements RelatorioTempoMedioRepository {
    ...
    public RelatorioTempoMedioRepositoryImpl(EntityManager em) {
        this.em = em;
    }
